"""Shared building blocks for the encoder training script.

Tokenization, dataset preparation, stratified eval subsampling, and
eval-step cadence helpers used by `train_encoder_balanced.py`.
"""
